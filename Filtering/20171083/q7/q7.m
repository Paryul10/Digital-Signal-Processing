...
figure(fig_count); imagesc(abs(my_spec)); title('My Spectogram') ; fig_count = fig_count + 1;
% ((my_spec));
inbuilt_spec = spectrogram(y, windowsize, stride, nfft);
figure(fig_count); imagesc(abs(inbuilt_spec)); title('Inbuilt Spectogram');fig_count = fig_count + 1;
% figure; spectogram(y);
